insert into categories (name) values ('Bread'), ('Cakes'), ('Cookies'), ('Sandwiches'), ('Chocolate');
...
--
-- insert into users (id, hash_password, role, display_name, delivery_address, email)
